...
export default function Hero() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-between min-h-[calc(100vh-96px)] h-[calc(100vh-96px)] w-full bg-[#FCFCF6] overflow-hidden">
      {/* Subheadline */}
      <div className="flex-1 flex flex-col items-center justify-center w-full -mt-82">
        <motion.div
        ...
        >
          <div className="uppercase text-gray-400 tracking-widest text-sm mb-2 font-satoshi">What&apos;s in your kitchen?</div>
          <h1 className="text-5xl md:text-6xl font-extrabold text-center text-black leading-tight mb-4 font-satoshi">
      ...
      <div className="md:hidden w-full absolute left-0 bottom-0 pb-8 z-0">
        <Ticker />
      </div>
    </section>
  );
